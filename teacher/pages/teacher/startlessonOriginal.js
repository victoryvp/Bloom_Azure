                            ...
                            <div className="row">
								<div className="col-xl-12 col-md-12 lessonplan_detail">
                                    <div className="card">
                                        ...
                                        <div className="card-block">
											<ul className="nav nav-tabs" id="myTab" role="tablist">
												...
												<li className="nav-item">
													<a className="nav-link text-uppercase" id="essentials-tab" data-toggle="tab" href="#essentials" role="tab" aria-controls="essentials" aria-selected="false" onClick={showNavItem}>Essentials</a>
												</li>
												<li className="nav-item">
													<a className="nav-link text-uppercase" id="Engage-tab" data-toggle="tab" href="#Engage" role="tab" aria-controls="Engage" aria-selected="false">Engage</a>
												</li>
												<li className="nav-item">
													<a className="nav-link text-uppercase" id="Explore-tab" data-toggle="tab" href="#Explore" role="tab" aria-controls="Explore" aria-selected="false">Explore</a>
												</li>
												<li className="nav-item">
													<a className="nav-link text-uppercase" id="Explain-tab" data-toggle="tab" href="#Explain" role="tab" aria-controls="Explain" aria-selected="false">Explain</a>
												</li>
												<li className="nav-item">
													<a className="nav-link text-uppercase" id="Elaborate-tab" data-toggle="tab" href="#Elaborate" role="tab" aria-controls="Elaborate" aria-selected="false">Elaborate</a>
												</li>
												<li className="nav-item">
													<a className="nav-link text-uppercase" id="Evaluate-tab" data-toggle="tab" href="#Evaluate" role="tab" aria-controls="Evaluate" aria-selected="false">Evaluate</a>
												</li>
												<li className="nav-item">
													<a className="nav-link text-uppercase" id="Intervention-tab" data-toggle="tab" href="#Intervention" role="tab" aria-controls="Intervention" aria-selected="false">Intervention</a>
												</li>
												<li className="nav-item">
													<a className="nav-link text-uppercase" id="Acceleration-tab" data-toggle="tab" href="#Acceleration" role="tab" aria-controls="Acceleration" aria-selected="false">Acceleration</a>
												</li>
											</ul>
											</div>
                                    <div className="tab-content" id="myTabContent">
											...
											<div className="row">
													...
													<div className="plandiv">
														<div className="table-responsive">
															<table className="table table-bordered plantable">
																...
																<tr className="planitem">
																	<td><b>EVALUATE:
																	Formative Monitoring (Questioning / Discussion):<br/>Summative Assessment (Quiz / Project / Report):</b></td>
																	<td colspan="2">After students are given a chance to experiment they present their demonstrations to the  class. In their demonstrations they must explain what they have learned about energy. Students also will turn in their notes from the day.</td>
																</tr>
																	
																<tr className="planitem">
																	<td><b>Elaborate Further / Reflect:</b></td>	
																	
																	<td colspan="2">Explain that moving forward the students will have more opportunity to experiment with energy.</td>
												...
												<div className="col-12">
													<ul className="task-list">
														<li>
															<i className="task-icon bg-c-green lessonplancircle"></i>
															<h6>Reference : <span className="lessonplanitem text-muted"/><a href="http://www.teachengineering.org/curricularunits/view/cub_energy2_curricularunit" target="_blank"><label className="label theme-bg text-white f-12 f-w-400 m-r-10">Link to Energy Article</label></a></h6>
                                        ...
                                        <div className="tab-pane fade" id="essentials" role="tabpanel" aria-labelledby="essentials-tab">
											{/* <?php include("essentials.php"); ?> */}
											{/* <Essentials/> */}
										</div>
                                        <div className="tab-pane fade" id="Engage" role="tabpanel" aria-labelledby="Engage-tab">
											{/* <?php include("engage.php"); ?> */}
										</div>
                                        <div className="tab-pane fade" id="Explore" role="tabpanel" aria-labelledby="Explore-tab">
											{/* <?php include("explore.php"); ?> */}
										</div>
                                        <div className="tab-pane fade" id="Explain" role="tabpanel" aria-labelledby="Explain-tab">
											{/* <?php include("explain.php"); ?> */}
										</div>
                                        <div className="tab-pane fade" id="Elaborate" role="tabpanel" aria-labelledby="Elaborate-tab">
											{/* <?php include("elaborate.php"); ?> */}
										</div>
                                        <div className="tab-pane fade" id="Evaluate" role="tabpanel" aria-labelledby="Evaluate-tab">
											{/* <?php include("evaluate.php"); ?> */}
										</div>
                                        <div className="tab-pane fade" id="Intervention" role="tabpanel" aria-labelledby="Intervention-tab">
											{/* <?php include("intervention.php"); ?> */}
										</div>
                                        <div className="tab-pane fade" id="Acceleration" role="tabpanel" aria-labelledby="Acceleration-tab">
											{/* <?php include("acceleration.php"); ?> */}
										</div>
                                    </div>
